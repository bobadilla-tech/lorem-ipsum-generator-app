...
export const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    faqQuestion:
      "Why does mobile app placeholder text need to be shorter than website text?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "What placeholder text mistakes are specific to dashboard mockups?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "Should I use HTML or plain text for email template placeholder copy?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "How should placeholder text differ between a product title and its description?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "How much text should go on a single presentation slide mockup?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "Does placeholder text length matter differently across social platforms?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "Should chatbot placeholder text be one paragraph or multiple short messages?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "How much placeholder text belongs on a single onboarding screen?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "Do error pages and empty states need their own placeholder text strategy?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "Should a newsletter subject line use the same placeholder text as the body?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "How is placeholder text for documentation different from a blog post?",
    faqAnswer:
  ...
  },
  {
    ...
    faqQuestion:
      "Should wireframes use themed placeholder text like Pirate or Tech Ipsum?",
    faqAnswer:
