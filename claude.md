...
**Lorem Ipsum Generator** - A modern, ad-optimized web application for generating Lorem Ipsum text, random emails, URLs, and domain names. Built with Astro 5, designed for passive income through Google AdSense.

- **Live Site**: https://lorem-ipsum.bobadilla.tech
- **GitHub**: https://github.com/bobadilla-tech/lorem-ipsum-generator-app
- **Inspiration**: [Lorelai](https://github.com/bobadilla-tech/lorelai) (Go library)
...
- **Word Bank**: 180+ Latin words from Cicero's "De finibus bonorum et malorum" (45 BC)
- **Options**:
...
- **Emails**: Realistic fake addresses (gmail, yahoo, hotmail, outlook, example.com)
- **URLs**: Random domains with paths (blog, about, products, etc.)
- **Domains**: Random names with TLDs (.com, .net, .org, .io, .dev, .app, .co, .tech, .info, .biz)
...
- BaseHead.astro:51 - `type` attribute on JSON-LD script
**Solution**: Ignore these - they're just hints, not errors
...
- **Lorelai**: https://github.com/bobadilla-tech/lorelai (Go library inspiration)
